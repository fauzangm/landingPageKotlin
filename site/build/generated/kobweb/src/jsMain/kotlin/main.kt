...
public fun main(): Unit {
    ...
    com.varabyte.kobweb.core.init.initKobweb(router) { ctx ->
        ctx.router.register("/") { com.eduside.landingpage.pages.HomePage() }
    ...
    com.varabyte.kobweb.silk.init.initSilkHook = { ctx ->
        com.eduside.landingpage.updateTheme(ctx)
    }
    ...
    renderComposable(rootElementId = "root") {
        CompositionLocalProvider(
            AppGlobalsLocal provides mapOf("title" to "LandingPage")
        ) { com.eduside.landingpage.MyApp {
